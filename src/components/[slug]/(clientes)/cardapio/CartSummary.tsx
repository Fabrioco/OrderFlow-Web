...
export function CartSummary({
  ...
  return (
    <div className="fixed bottom-25 left-1/2 -translate-x-1/2 w-[calc(100%-3rem)] max-w-lg z-50">
      <button
        onClick={openCart}
        className="w-full h-16 bg-[#D2BBFF] text-[#25005A] font-black rounded-4xl flex items-center justify-between px-7 shadow-[0_20px_50px_rgba(210,187,255,0.3)] active:scale-95 transition-all"
      >
